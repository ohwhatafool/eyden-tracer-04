...
public:
	...
	virtual Vec3f Shade(const Ray &ray) const override
	{
		...
		//find the surface derivates in u and v direction, called dPdu and dPdv.
		//Formula taken from question itself
		Vec3f dPdu = (1, 0, 0);
		Vec3f dPdv = (0, 0, 1);
		...
		//Below part copied from Professor's pre0defined ShaderPhong.h -> Shade function:
		...
		for (auto pLight : m_scene.m_vpLights)
			...
			{ // TODO: make the sampling to depend on the light source type
